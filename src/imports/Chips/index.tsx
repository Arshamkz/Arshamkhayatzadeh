import svgPaths from "./svg-x4xagbujkg";
type ChipsProps = {
  className?: string;
                  ...
                  <div className="absolute inset-[16.67%]" data-name="elements">
                    <div className="absolute inset-[-3.13%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
                        <g id="elements">
                          <path d="M8.5 0.5V16.5" id="Vector 4048" stroke="var(--stroke-0, #16181B)" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M0.5 8.5H16.5" id="Vector 4049" stroke="var(--stroke-0, #16181B)" strokeLinecap="round" strokeLinejoin="round" />
                        </g>
                      </svg>
                    </div>
                  </div>
                  ...
                  <div className="absolute inset-[16.67%]" data-name="elements">
                    <div className="absolute inset-[-3.75%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3333 14.3333">
                        <g id="elements">
                          <path d="M7.16667 0.5V13.8333" id="Vector 4048" stroke="var(--stroke-0, #16181B)" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M0.5 7.16667H13.8333" id="Vector 4049" stroke="var(--stroke-0, #16181B)" strokeLinecap="round" strokeLinejoin="round" />
                        </g>
                      </svg>
                    </div>
                  </div>
